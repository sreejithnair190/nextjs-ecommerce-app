...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAID', 'FAILED', 'REFUNDED', 'CANCELLED', 'FULFILLED');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('REQUIRES_PAYMENT', 'PROCESSING', 'SUCCEEDED', 'FAILED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('PRODUCT_CREATED', 'PRODUCT_UPDATED', 'PRODUCT_DELETED', 'ORDER_STATUS_CHANGED', 'REFUND_ISSUED', 'USER_ROLE_CHANGED', 'USER_BANNED', 'CATEGORY_CREATED', 'CATEGORY_UPDATED', 'CATEGORY_DELETED');
...
-- CreateEnum
CREATE TYPE "InventoryChangeType" AS ENUM ('RESTOCK', 'SALE', 'ADMIN_ADJUSTMENT', 'RETURN', 'DAMAGED');
